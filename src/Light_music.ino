/*
  ...
  Піни (зміни під свою плату):
    LED_PIN    = 3   -> DIN стрічки (через резистор ~330 Ом) — GPIO4 спалено, перенесено сюди
    ...
    GPIO1      -> кнопка скидання WiFi #2 (окрема виносна кнопка, опційно;
                  одна нога кнопки на GPIO1, друга на GND, нічого більше не треба —
                  внутрішній підтягуючий резистор увімкнений програмно.
                  GPIO10 теоретично теж вільний, але на конкретній платі
                  спричиняв відмову старту — якщо матимеш той самий досвід,
                  просто спробуй інший вільний пін)
...
#define WIFI_RESET_BUTTON_PIN2 1     // окрема виносна кнопка — GPIO10 виявився проблемним
                                      // на конкретній платі (не стартувала), тож GPIO1
                                      // підключити просто: одна нога кнопки на GPIO1, друга на GND
